            ...
            <div className="flex flex-col p-3 w-4/5 ">
              ...
              <div className="flex flex-col md:flex-row">
                <div className="basis-1/2 mt-5 flex flex-col md:flex-row gap-3 content-center ">
                  ...
                  <div className="w-full md:w-7/12"><input name="Material thickness :" defaultValue={Gdata.Material_Name} className="border rounded-md  px-2 py-1 w-10/12  text-black focus:outline-none  text-lg"/></div>       
                </div>
                <div className="basis-1/2 mt-5 flex flex-col md:flex-row gap-3 content-center ">
                  <p className="text-lg text-black-400 basis-5/12">Lattice :</p>
                  <div className="w-full md:w-7/12"><input name="Material thickness :" defaultValue={Gdata.Lattice_Type} className="border rounded-md  px-2 py-1 w-10/12  text-black focus:outline-none  text-lg"/></div>       
                </div>      
              </div>
              ...
              <div className="flex flex-col md:flex-row">
                <div className="basis-1/2 mt-5 flex flex-col md:flex-row gap-3 content-center ">
                  ...
                  <div className="w-full md:w-7/12"><input name="Material thickness :" defaultValue={Gdata.Inequivalent_Atoms} className="border rounded-md  px-2 py-1 w-10/12  text-black focus:outline-none  text-lg"/></div>       
                </div>
                <div className="basis-1/2 mt-5 flex flex-col md:flex-row gap-3 content-center ">
